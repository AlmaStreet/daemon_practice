...
class Daemon:
    ...
    user_defined_output_dir = os.getenv('DAEMONKIT_OUTPUT_DIR') or config.get("DEFAULT", "output_dir", fallback=None)

    # Determine the default output directory
    script_dir = os.path.dirname(os.path.abspath(__file__))
    repo_dir = os.path.abspath(os.path.join(script_dir, os.pardir))  # Go up one level to reach the repo root
    DEFAULT_OUTPUT_DIR = user_defined_output_dir if user_defined_output_dir else os.path.join(repo_dir, 'daemon_data')
